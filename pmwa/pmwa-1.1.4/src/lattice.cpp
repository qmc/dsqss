...
Lattice::Lattice(const char* FNAME,  Size *_N, Parallel *_PR ) {
...
void Lattice::read() {
  ...
  for(int l=0; l<lc; l++){
    ...
    if(l==0)       bond_vec[l][0]=1.0;
    else if(l==1)  bond_vec[l][1]=1.0;
    else           bond_vec[l][2]=1.0;
...
//======================================================================
#include <set>
void Lattice::initialize( Size *_N, Parallel *_PR ) {

#ifdef DEBUG
  printf("Lattice::initialize> Start.\n");
#endif
  set_Size(_N);
  set_Parallel(_PR);

#ifdef DEBUG
  printf("Lattice::initialize> End.\n");
#endif
}


void Lattice::set_Size( Size *_N ){
...
void Lattice::set_Parallel( Parallel *_PR ){
...
void Lattice::show_param(ofstream &F) {
