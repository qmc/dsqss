...
namespace Specific {
  ...
  enum                        {  NV1 , EB1 , EB2 , LE1 , MZU1 , MZU2 , MZUA1 , MZUA2 , MZS1 , MZS2 , MZSA1 , MZSA2 , NH1 , Wxy2,  MZQ2 , NACC };
  static string ANAME[NACC] = { "nv1","eb1","eb2","le1","mzu1","mzu2","mzua1","mzua2","mzs1","mzs2","mzsa1","mzsa2","nh1","wxy2", "mzq2" };

  // observable specifier
  //    NPHY = number of quantities computed at each set

  enum                        {  ANV , ENE , SPE , LEN , XMX , AMZU , BMZU , SMZU , XMZU , AMZS , BMZS , SMZS , XMZS,  DS1 , W2  , RHOS , COMP  , SMZQ, NPHY };
  static string PNAME[NPHY] = { "anv","ene","spe","len","xmx","amzu","bmzu","smzu","xmzu","amzs","bmzs","smzs","xmzs","ds1","wi2","rhos", "comp", "smzq" };
